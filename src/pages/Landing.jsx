      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 1100, margin: '0 auto', width: '100%' }}>
        <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
          ...
          <div>
            ...
            <h1 className="hero-h1" style={{ fontSize: 54, fontWeight: 800, color: T.text, letterSpacing: -2, lineHeight: 1.05, margin: '0 0 20px', fontFamily: T.sans }}>
      ...
      <div style={{ maxWidth: 840, margin: '0 auto' }}>
        ...
        <div className="pricing-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
          ...
          <div style={{ background: T.panel, border: `1px solid ${T.accentBd}`, borderRadius: 12, padding: '36px 32px', position: 'relative', overflow: 'hidden' }}>
            ...
            {waitStatus === 'done' ? (
              <div style={{ marginTop: 32, padding: '14px 0', textAlign: 'center', fontFamily: T.mono, fontSize: 13, color: T.accent, background: T.accentLo, border: `1px solid ${T.accentBd}`, borderRadius: 8 }}>
                ✓ You're on the list
              </div>
            ) : (
              <form onSubmit={joinWaitlist} style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 8 }}>
                <input
                  type="email"
                  value={waitEmail}
                  ...
                  required
                  style={{ width: '100%', background: T.bg, border: `1px solid ${T.border}`, borderRadius: 8, padding: '12px 14px', fontFamily: T.mono, fontSize: 13, color: T.text, outline: 'none', boxSizing: 'border-box' }}
                />
                <button type="submit" disabled={waitStatus === 'loading'} style={{ width: '100%', background: T.accentLo, color: T.accent, border: `1px solid ${T.accentBd}`, borderRadius: 8, padding: '13px 0', fontFamily: T.mono, fontSize: 13, fontWeight: 700, cursor: waitStatus === 'loading' ? 'wait' : 'pointer' }}>
  ...
  return (
    <section style={{ padding: '100px 24px', background: T.bg, borderTop: `1px solid ${T.border}` }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <div className="usecases-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 2, background: T.border }}>
          {cases.map((c, i) => (
